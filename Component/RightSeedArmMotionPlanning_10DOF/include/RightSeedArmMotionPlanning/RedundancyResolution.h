...
class Redundancy{
 ...
 public:
  ...
  int getRightRedundantJoint_CollisionCheck(double eerot[9], double eetrans[3], double nowJoint[4], double redundancyJoint[], double endEEtrans[], std::vector<AABB> aabb, int setObstacleNum);
  int getLeftRedundantJoint(double eerot[9], double eetrans[3], double nowJoint[4], double redundancyJoint[], double endEEtrans[]);
  int getLeftRedundantJoint_CollisionCheck(double eerot[9], double eetrans[3], double nowJoint[4], double redundancyJoint[], double endEEtrans[], std::vector<AABB> aabb, int setObstacleNum);
};
