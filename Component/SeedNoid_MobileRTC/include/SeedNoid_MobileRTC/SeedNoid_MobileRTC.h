  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
  ...
  /*!
   */
  SeedNoid_Lifter_LifterPoseSVC_impl m_LifterPose;
...
public:
  ...
  bool CheckAngle(struct Lifter inputAngle)
  {
    return SC.CheckTargetAngle(inputAngle);
  }

  bool CheckPose(struct Pose inputPose)
  {
    return SC.CheckTargetPose(inputPose);
  }

  void moveLifterForwardKinematics(struct Lifter lifterAngle, int moveTime)
  {
    SC.seedMoveLifterForwardKinematics(lifterAngle,moveTime);
  }

  void moveLifterInverseKinematics(struct Pose lifterPose, int moveTime)
  {
    SC.seedMoveLifterInverseKinematics(lifterPose,moveTime);
  }

  void currentLifterAngle()
  {
    SC.seedGetLifterAngle(LifterAngle);
  }

  void currentLifterPose()
  {
    SC.seedGetLifterPose(LifterPose);
  }
};
